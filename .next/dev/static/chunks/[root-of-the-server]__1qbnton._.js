...
"[project]/src/screens/Test.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function isMcqCorrect(q, selected) {
    const key = new Set(q.kind === "multiSelect" ? q.answerIndices ?? [] : q.answerIndex != null ? [
        q.answerIndex
    ] : []);
...
function Test() {
    ...
    const progress = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$progressStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProgressStore"])({
        "Test.useProgressStore[progress]": (s)=>s.progress
    }["Test.useProgressStore[progress]"]);
    const submitTest = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$progressStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProgressStore"])({
        "Test.useProgressStore[submitTest]": (s)=>s.submitTest
    }["Test.useProgressStore[submitTest]"]);
    const pool = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Test.useMemo[pool]": ()=>(module?.testPoolProblemIds ?? []).map({
                "Test.useMemo[pool]": (id)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$curriculum$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getProblem"])(id)
            }["Test.useMemo[pool]"]).filter({
                "Test.useMemo[pool]": (p)=>Boolean(p)
            }["Test.useMemo[pool]"])
    }["Test.useMemo[pool]"], [
        module
    ]);
    const mcqPool = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Test.useMemo[mcqPool]": ()=>{
            const ids = module?.complexityQuestionIds ?? [];
            const own = ids.map({
                "Test.useMemo[mcqPool].own": (id)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$curriculum$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["complexityQuestions"][id]
            }["Test.useMemo[mcqPool].own"]).filter({
                "Test.useMemo[mcqPool].own": (q)=>Boolean(q)
            }["Test.useMemo[mcqPool].own"]);
            return own.length > 0 ? own : Object.values(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$curriculum$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["complexityQuestions"]);
        }
    }["Test.useMemo[mcqPool]"], [
        module
    ]);
    const config = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Test.useMemo[config]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$testEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildTestConfig"])(moduleId)
    }["Test.useMemo[config]"], [
        moduleId
    ]);
    ...
    const [drawnProblemIds, setDrawnProblemIds] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [drawnMcqIds, setDrawnMcqIds] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const retake = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$testEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["retakeStatus"])(progress, moduleId);
    ...
    const finalize = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Test.useCallback[finalize]": ()=>{
            const elapsed = Math.min(timeLimitMs, Date.now() - startTime);
            const problemsSolved = drawnProblemIds.filter({
                "Test.useCallback[finalize]": (id)=>solved.has(id)
            }["Test.useCallback[finalize]"]).length;
            const mcqCorrect = drawnMcqIds.filter({
                "Test.useCallback[finalize]": (qid)=>{
                    const q = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$curriculum$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["complexityQuestions"][qid];
                    return q ? isMcqCorrect(q, mcqAnswers[qid] ?? []) : false;
                }
            }["Test.useCallback[finalize]"]).length;
            const score = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$testEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["scoreTest"])(problemsSolved, drawnProblemIds.length, mcqCorrect, drawnMcqIds.length);
            const tier = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$testEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["decideTier"])(score, elapsed, parMs, 0);
            const session = {
                id: `t-${Date.now()}`,
                moduleId,
                config,
                ...
                timeLimitMs,
                problemResults: drawnProblemIds.map({
                    "Test.useCallback[finalize]": (id)=>({
                            problemId: id,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Test.useEffect": ()=>{
            ...
            }["Test.useEffect.timer"], 1000);
            return ({
                "Test.useEffect": ()=>clearInterval(timer)
            })["Test.useEffect"];
        }
    }["Test.useEffect"], [
        phase,
    ...
    const startTest = ()=>{
        setDrawnProblemIds((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$testEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["drawProblems"])(pool, config.drawRules));
        setDrawnMcqIds((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$testEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["drawMcqs"])(mcqPool, config.complexityMcqCount));
        setSolved(new Set());
        setMcqAnswers({});
        const t = Date.now();
        setStartTime(t);
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PageHeader"], {
                    ...
                    subtitle: "This module has no test."
                }, void 0, false, {
                    fileName: "[project]/src/screens/Test.tsx",
                    lineNumber: 150,
                    columnNumber: 9
                }, this),
    ...
    if (pool.length === 0) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PageHeader"], {
                    title: module.title,
                    subtitle: "No test pool is registered for this module yet."
                }, void 0, false, {
                    fileName: "[project]/src/screens/Test.tsx",
                    lineNumber: 160,
                    columnNumber: 9
    ...
    const problemTarget = Math.min(pool.length, config.drawRules.easy + config.drawRules.medium + config.drawRules.hard);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
            ...
            phase === "config" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ConfigScreen, {
                title: module.title,
            ...
            phase === "running" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(RunningScreen, {
                problems: drawnProblemIds.map((id)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$curriculum$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getProblem"])(id)).filter(Boolean),
                mcqs: drawnMcqIds.map((id)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$curriculum$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["complexityQuestions"][id]).filter(Boolean),
                ...
                onAnswer: (qid, sel)=>setMcqAnswers((prev)=>({
                            ...prev,
                            [qid]: sel
                        })),
                onSubmit: finalize
            ...
            phase === "results" && result && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ResultsScreen, {
                result: result,
                onRetake: startTest,
                retakeAllowed: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$testEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["retakeStatus"])(progress, moduleId).allowed,
                retakeRemainingMs: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$testEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["retakeStatus"])(progress, moduleId).remainingMs,
                moduleId: moduleId
            }, void 0, false, {
                fileName: "[project]/src/screens/Test.tsx",
                lineNumber: 207,
...
_s(Test, "QYF1Ed9TAR3Z9dk+QUi/4Y3A8c4=", false, function() {
    return [
...
_c = Test;
/* ----------------------------- Config ----------------------------- */ function ConfigScreen({ title, problemTarget, poolSize, mcqTarget, config, bestTier, retakeAllowed, retakeRemainingMs, onStart }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PageHeader"], {
                title: `${title} — Timed Test`,
                subtitle: "Hints are disabled. Auto-submits at time up."
            }, void 0, false, {
                fileName: "[project]/src/screens/Test.tsx",
                lineNumber: 244,
                columnNumber: 7
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("b", {
                                    children: problemTarget
                                }, void 0, false, {
                                    fileName: "[project]/src/screens/Test.tsx",
                                    lineNumber: 248,
                                    columnNumber: 13
                                }, this),
                                " problems drawn at random from a pool of ",
                                poolSize,
                                "."
                            ]
                        }, void 0, true, {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                            children: [
                                ...
                                " complexity multiple-choice questions (worth 10% of the score)."
                            ]
                        }, void 0, true, {
                            fileName: "[project]/src/screens/Test.tsx",
                            lineNumber: 250,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                            children: "Tiers: Bronze ≥60% · Silver ≥75% · Gold ≥90% · Platinum = 100% within par, hint-free."
                        }, void 0, false, {
                            fileName: "[project]/src/screens/Test.tsx",
                            lineNumber: 257,
                            columnNumber: 11
                        }, this),
                        bestTier && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
            ...
            retakeAllowed ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                type: "button",
                onClick: onStart,
                ...
                className: "rounded-lg border border-amber-300 bg-amber-50 px-4 py-3 text-sm text-amber-800 dark:border-amber-900/60 dark:bg-amber-950/30 dark:text-amber-200",
                children: [
                    "Retake available in ",
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("b", {
                        children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$testEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDuration"])(retakeRemainingMs)
                    }, void 0, false, {
                        fileName: "[project]/src/screens/Test.tsx",
                        lineNumber: 276,
                        columnNumber: 31
                    }, this),
                    " (12-hour cooldown). Your best tier is kept."
                ]
            }, void 0, true, {
                fileName: "[project]/src/screens/Test.tsx",
                lineNumber: 275,
...
_c1 = ConfigScreen;
/* ----------------------------- Running ----------------------------- */ function RunningScreen({ problems, mcqs, remainingMs, solvedCount, answeredCount, mcqAnswers, onSolve, onAnswer, onSubmit }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cn$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("font-mono text-lg font-bold tabular-nums", low ? "text-red-500" : "text-slate-700 dark:text-slate-200"),
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "space-y-4",
                children: [
                    problems.map((p, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(TestProblemCard, {
                            index: i + 1,
                            problem: p,
                            onSolve: ()=>onSolve(p.id)
                        }, p.id, false, {
                            fileName: "[project]/src/screens/Test.tsx",
                            lineNumber: 335,
                            columnNumber: 11
                        }, this)),
                    mcqs.map((q, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(TestMcqCard, {
...
_c2 = RunningScreen;
function TestProblemCard({ index, problem, onSolve }) {
    _s1();
    const preferred = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$progressStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProgressStore"])({
        "TestProblemCard.useProgressStore[preferred]": (s)=>s.progress.settings.preferredLanguage
    }["TestProblemCard.useProgressStore[preferred]"]);
...
_s1(TestProblemCard, "u+IzFF3MavOFR9ObYLkRhFvrEEI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$progressStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProgressStore"],
...
_c3 = TestProblemCard;
function TestMcqCard({ index, question, selected, onChange }) {
    const isMulti = question.kind === "multiSelect";
    const options = question.options ?? [];
    const toggle = (i)=>{
        if (isMulti) {
            onChange(selected.includes(i) ? selected.filter((x)=>x !== i) : [
                ...selected,
                i
            ]);
        } else {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: options.map((opt, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cn$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("flex h-4 w-4 items-center justify-center border text-[10px]", isMulti ? "rounded" : "rounded-full", selected.includes(i) ? "border-forge-500 bg-forge-500 text-white" : "border-slate-400"),
                                children: selected.includes(i) ? "✓" : ""
                            }, void 0, false, {
                                fileName: "[project]/src/screens/Test.tsx",
                                lineNumber: 495,
                                columnNumber: 13
...
_c4 = TestMcqCard;
/* ----------------------------- Results ----------------------------- */ const TIER_STYLE = {
    bronze: "bg-amber-700",
    silver: "bg-slate-400",
    gold: "bg-yellow-500",
    platinum: "bg-cyan-400"
};
function ResultsScreen({ result, onRetake, retakeAllowed, retakeRemainingMs, moduleId }) {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: tier ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            ...
                            className: "text-sm text-slate-500 dark:text-slate-400",
                            children: "No badge yet — reach 60% for Bronze."
                        }, void 0, false, {
                            fileName: "[project]/src/screens/Test.tsx",
                            lineNumber: 554,
                            columnNumber: 13
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    retakeAllowed ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        children: [
                            "Retake in ",
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$testEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDuration"])(retakeRemainingMs),
                            "."
                        ]
                    }, void 0, true, {
                        fileName: "[project]/src/screens/Test.tsx",
...
__turbopack_context__.k.register(_c1, "ConfigScreen");
__turbopack_context__.k.register(_c2, "RunningScreen");
__turbopack_context__.k.register(_c3, "TestProblemCard");
__turbopack_context__.k.register(_c4, "TestMcqCard");
__turbopack_context__.k.register(_c5, "ResultsScreen");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/screens/Test.tsx [app-client] (ecmascript, next/dynamic entry)", (function(__turbopack_context__){

__turbopack_context__.n(__turbopack_context__.i("[project]/src/screens/Test.tsx [app-client] (ecmascript)"));
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1qbnton._.js.map