...
"[project]/src/data/languages.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
**Tip:** Make the happy path easy to read. Small functions with one clear purpose are often better than a large function with many nested conditions.`
        ...
        quiz: {
            ...
            options: [
                "It prints value",
                "It sends value back to its caller",
                "It repeats the function",
                "It makes value global"
            ],
            answerIndex: 1,
...
**Rule of thumb:** \`await\` only works inside an \`async\` function (or a JavaScript module's top level).`
        ...
        quiz: {
            ...
            options: [
                "It turns off errors",
                "It waits for a promise to settle before continuing that function",
                "It blocks the whole browser",
                "It repeats a request forever"
            ],
            answerIndex: 1,
...
function getLanguageCourse(id) {
    return languageCourses.find((course)=>course.id === id);
}
function languageLessonProgressId(courseId, lessonId) {
...
"[project]/src/screens/LanguageCourse.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$languages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/data/languages.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/constants.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cn$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/cn.ts [app-client] (ecmascript)");
...
function LanguageCourse() {
    _s();
    const { courseId = "" } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$router$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"])();
    const course = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$languages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLanguageCourse"])(courseId);
    const lessonCompletions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$progressStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProgressStore"])({
        "LanguageCourse.useProgressStore[lessonCompletions]": (s)=>s.progress.lessonCompletions
    }["LanguageCourse.useProgressStore[lessonCompletions]"]);
    const completeLesson = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$progressStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProgressStore"])({
        "LanguageCourse.useProgressStore[completeLesson]": (s)=>s.completeLesson
    }["LanguageCourse.useProgressStore[completeLesson]"]);
    const [activeLessonId, setActiveLessonId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(course?.lessons[0]?.id ?? "");
    if (!course || !course.available) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$router$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Navigate"], {
        to: "/languages",
        replace: true
    }, void 0, false, {
        fileName: "[project]/src/screens/LanguageCourse.tsx",
        lineNumber: 18,
        columnNumber: 44
    }, this);
    const activeLesson = course.lessons.find((lesson)=>lesson.id === activeLessonId) ?? course.lessons[0];
    if (!activeLesson) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$router$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Navigate"], {
        to: "/languages",
        replace: true
    }, void 0, false, {
        fileName: "[project]/src/screens/LanguageCourse.tsx",
    ...
    const completeCount = course.lessons.filter((lesson)=>Boolean(lessonCompletions[(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$languages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["languageLessonProgressId"])(course.id, lesson.id)])).length;
    const progressId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$languages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["languageLessonProgressId"])(course.id, activeLesson.id);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                className: "mb-6 bg-gradient-to-r from-forge-500 to-forge-700 text-white",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("aside", {
                        className: "h-fit rounded-xl border border-slate-200 bg-white p-2 shadow-sm dark:border-slate-800 dark:bg-slate-900",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "px-3 pb-2 pt-1 text-[11px] font-semibold uppercase tracking-wide text-slate-400",
                                children: "Lessons"
                            }, void 0, false, {
                                fileName: "[project]/src/screens/LanguageCourse.tsx",
                                lineNumber: 45,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: course.lessons.map((lesson, index)=>{
                                    const done = Boolean(lessonCompletions[(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$languages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["languageLessonProgressId"])(course.id, lesson.id)]);
                                    const active = lesson.id === activeLesson.id;
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        type: "button",
                                        onClick: ()=>setActiveLessonId(lesson.id),
                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cn$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left text-sm transition", active ? "bg-forge-50 text-forge-700 dark:bg-forge-900/25 dark:text-forge-300" : "hover:bg-slate-50 dark:hover:bg-slate-800"),
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cn$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("flex h-5 w-5 shrink-0 items-center justify-center rounded-full text-[10px] font-bold", done ? "bg-emerald-500 text-white" : active ? "bg-forge-500 text-white" : "bg-slate-100 text-slate-500 dark:bg-slate-800 dark:text-slate-400"),
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("article", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "mb-2 text-[11px] font-semibold uppercase tracking-wide text-forge-500",
                                        children: [
                                            "Lesson ",
                            ...
                            activeLesson.sections.map((section)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                                    className: "mb-7",
                                    children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                type: "button",
                                disabled: isComplete,
                                onClick: ()=>completeLesson(progressId, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["XP"].lesson),
                                ...
                                children: isComplete ? "✓ Lesson completed" : `Mark lesson complete (+${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["XP"].lesson} XP)`
                            }, void 0, false, {
                                fileName: "[project]/src/screens/LanguageCourse.tsx",
                                lineNumber: 86,
                                columnNumber: 11
...
_s(LanguageCourse, "Cn+lpD0U/s1ErWYAvBVZJ6uNaf8=", false, function() {
    return [
...
_c = LanguageCourse;
var _c;
__turbopack_context__.k.register(_c, "LanguageCourse");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/screens/LanguageCourse.tsx [app-client] (ecmascript, next/dynamic entry)", (function(__turbopack_context__){

__turbopack_context__.n(__turbopack_context__.i("[project]/src/screens/LanguageCourse.tsx [app-client] (ecmascript)"));
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0vjo6hh._.js.map