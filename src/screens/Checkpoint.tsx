  ...
  return (
    <div>
      ...
      <SignInGate
        ...
        title={module.title}
        subtitle="Sign in to unlock this checkpoint."
      >
        ...
        <Card className="mb-6 flex flex-wrap items-center justify-between gap-3 border-forge-200 bg-forge-50 dark:border-forge-800 dark:bg-forge-900/20">
          <p className="text-sm text-slate-600 dark:text-slate-300">
            Ready? Take the <span className="font-semibold">timed checkpoint test</span> — a
            random draw from the pool plus complexity questions — to earn your Foundations badge.
            {earned && (
